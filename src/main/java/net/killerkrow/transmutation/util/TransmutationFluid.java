...
public abstract class TransmutationFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_TRANSMUTATION_WATER;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_TRANSMUTATION_WATER;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.TRANSMUTATION_WATER_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.TRANSMUTATION_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends TransmutationFluid {
        @Override
    ...
    public static class Still extends TransmutationFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
